package org.group.jcommon.protobuf;
...
public class Converters {
        ...
        public static Converter<Timestamp, OffsetDateTime> toOffsetDateTimeUTC = Converter.from(
                        t -> toInstantUTC.convert(t).atOffset(ZoneOffset.UTC),
                        o -> toInstantUTC.reverse().convert(o.toInstant()));

        public static Converter<Timestamp, ZonedDateTime> toZonedDateTimeUTC = Converter.from(
        ...
        public static Converter<com.google.protobuf.Duration, Duration> toDuration = Converter
                        .from(d -> Duration.ofSeconds(d.getSeconds(), d.getNanos()), d -> com.google.protobuf.Duration
                                        .newBuilder().setSeconds(d.getSeconds()).setNanos(d.getNano()).build());
}