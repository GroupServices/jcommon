...
/**
 * TimeFormatUtil A time formatter.
 *
 * Notes:
 *   default zone is {@code Asia/Shanghai}
 *   default datetime format is {@code yyyy-MM-dd HH:mm:ss}
 *
 * Need to reset the default settings if your app involves other international time zones or
 * datetime formats.
 */
